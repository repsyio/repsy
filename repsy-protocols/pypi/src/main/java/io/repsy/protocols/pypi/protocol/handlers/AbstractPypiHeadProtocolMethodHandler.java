...
@NullMarked
public abstract class AbstractPypiHeadProtocolMethodHandler implements ProtocolMethodHandler {

  private final PathParser pathParser;

  public AbstractPypiHeadProtocolMethodHandler(
      final PathParser pathParser, final PypiProtocolProvider provider) {
