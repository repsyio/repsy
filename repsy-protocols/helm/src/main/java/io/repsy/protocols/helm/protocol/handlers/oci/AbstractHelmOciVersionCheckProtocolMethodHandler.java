...
/** Handles GET/HEAD /v2/ — OCI API version check. */
@NullMarked
public abstract class AbstractHelmOciVersionCheckProtocolMethodHandler
    implements ProtocolMethodHandler {

  public AbstractHelmOciVersionCheckProtocolMethodHandler(final HelmProtocolProvider provider) {
