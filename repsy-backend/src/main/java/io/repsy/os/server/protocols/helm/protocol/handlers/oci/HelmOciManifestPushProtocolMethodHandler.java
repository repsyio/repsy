...
@Component
@NullMarked
public class HelmOciManifestPushProtocolMethodHandler
    extends AbstractHelmOciManifestPushProtocolMethodHandler<UUID> {

  public HelmOciManifestPushProtocolMethodHandler(
