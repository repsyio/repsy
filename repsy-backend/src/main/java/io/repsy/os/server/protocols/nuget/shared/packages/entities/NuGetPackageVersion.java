...
public class NuGetPackageVersion {
  ...
  /**
   * Identifier-based equality: two NuGet package versions are equal when they are the same instance
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof final NuGetPackageVersion other)) {
      return false;
    }
   ...
   * so a hash derived from them would move a NuGet package version held in a {@code HashSet} into
   * the wrong bucket. It also keeps the lazy associations out of the hash.
   */
  @Override
  public int hashCode() {
    return NuGetPackageVersion.class.hashCode();
  }
}
