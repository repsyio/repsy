...
import io.repsy.os.server.protocols.docker.protocol.utils.DockerLayerRenamer;
...
import io.repsy.protocols.docker.protocol.handlers.AbstractDockerManifestPushProtocolMethodHandler;
...
public class DockerManifestPushProtocolMethodHandler
  ...
  public DockerManifestPushProtocolMethodHandler(
      ...
      final DockerLayerRenamer layerRenamer,
