...
import io.repsy.protocols.docker.protocol.handlers.AbstractDockerManifestPullProtocolMethodHandler;
...
@Component
@NullMarked
public class DockerManifestPullProtocolMethodHandler
    extends AbstractDockerManifestPullProtocolMethodHandler<UUID> {

  public DockerManifestPullProtocolMethodHandler(
