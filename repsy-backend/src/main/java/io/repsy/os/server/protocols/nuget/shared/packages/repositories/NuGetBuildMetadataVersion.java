 ...
 * 1.0.0+build}), stored before the metadata was dropped from the canonical version (RPS-996).
 *
 * @param id the version row
 * @param packageRowId the {@code nuget_package} row the version belongs to
 * @param repoId the repo that owns the package
