...
@Component
@NullMarked
public class HelmOciBlobCheckProtocolMethodHandler
    extends AbstractHelmOciBlobCheckProtocolMethodHandler<UUID> {

  public HelmOciBlobCheckProtocolMethodHandler(
