...
@Component
@NullMarked
public class HelmOciManifestPullProtocolMethodHandler
    extends AbstractHelmOciManifestPullProtocolMethodHandler<UUID> {

  public HelmOciManifestPullProtocolMethodHandler(
