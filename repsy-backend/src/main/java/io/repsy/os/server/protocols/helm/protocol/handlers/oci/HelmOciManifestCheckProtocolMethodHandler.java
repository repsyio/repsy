...
@Component
@NullMarked
public class HelmOciManifestCheckProtocolMethodHandler
    extends AbstractHelmOciManifestCheckProtocolMethodHandler<UUID> {

  public HelmOciManifestCheckProtocolMethodHandler(
