...
@Repository
public interface VersionLicenseRepository extends JpaRepository<VersionLicense, UUID> {

  @NonNull List<VersionLicenseInfo> findAllByArtifactVersionId(UUID versionId);
