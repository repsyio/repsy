 ...
 *   <li>Only failed BCrypt checks count. A success never resets the count, so a client cannot clear
 *       it by logging in with an account of its own; only the end of the window does.
