...
@Data
@Entity
@Table(name = "npm_package_keyword")
@NoArgsConstructor
...
public class PackageKeyword {
  ...
  /**
   * Identifier-based equality: two package keywords are equal when they are the same instance or
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof final PackageKeyword other)) {
      return false;
    }
   ...
   * so a hash derived from them would move a package keyword held in a {@code HashSet} into the
   * wrong bucket. It also keeps the lazy associations out of the hash.
   */
  @Override
  public int hashCode() {
    return PackageKeyword.class.hashCode();
  }
}
