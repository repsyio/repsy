...
public class CargoUserController {
  ...
  public RestResponse<Boolean> canManage(
      @PathVariable final String repoName, @RequestHeader(AUTHORIZATION) final String authHeader) {
