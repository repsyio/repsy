...
import io.repsy.protocols.npm.protocol.handlers.AbstractNpmAuditBulkProtocolMethodHandler;
...
@Component
@NullMarked
public class NpmAuditBulkProtocolMethodHandler
    extends AbstractNpmAuditBulkProtocolMethodHandler<UUID> {
