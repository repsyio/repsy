...
@Component
@NullMarked
public class NuGetRegistrationLeafProtocolMethodHandler
    extends AbstractNuGetRegistrationProtocolMethodHandler {
  ...
  public NuGetRegistrationLeafProtocolMethodHandler(
    ...
    super(basePathParser, facade, provider, baseUrlResolver, false);
  }
}
