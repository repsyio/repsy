...
public class CargoAuthor {
  ...
  @Column(name = "author", nullable = false, unique = true, columnDefinition = "text")
  ...
  /**
   * Identifier-based equality: two cargo authors are equal when they are the same instance or carry
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof final CargoAuthor other)) {
      return false;
    }
   ...
   * so a hash derived from them would move a cargo author held in a {@code HashSet} into the wrong
   * bucket. It also keeps the lazy associations out of the hash.
   */
  @Override
  public int hashCode() {
    return CargoAuthor.class.hashCode();
  }
}
