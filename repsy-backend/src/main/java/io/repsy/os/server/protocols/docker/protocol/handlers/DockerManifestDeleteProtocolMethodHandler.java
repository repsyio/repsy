...
import io.repsy.protocols.docker.protocol.handlers.AbstractDockerManifestDeleteProtocolMethodHandler;
...
@Component
@NullMarked
public class DockerManifestDeleteProtocolMethodHandler
    extends AbstractDockerManifestDeleteProtocolMethodHandler<UUID> {

  public DockerManifestDeleteProtocolMethodHandler(
