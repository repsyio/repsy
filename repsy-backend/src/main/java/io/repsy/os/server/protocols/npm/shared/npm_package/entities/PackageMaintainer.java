...
public class PackageMaintainer {
  ...
  /**
   * Identifier-based equality: two package maintainers are equal when they are the same instance or
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof final PackageMaintainer other)) {
      return false;
    }
   ...
   * so a hash derived from them would move a package maintainer held in a {@code HashSet} into the
   * wrong bucket. It also keeps the lazy associations out of the hash.
   */
  @Override
  public int hashCode() {
    return PackageMaintainer.class.hashCode();
  }
}
