...
@Component
@NullMarked
public class HelmOciVersionCheckProtocolMethodHandler
    extends AbstractHelmOciVersionCheckProtocolMethodHandler {

  public HelmOciVersionCheckProtocolMethodHandler(final HelmProtocolProvider provider) {
    super(provider);
  }
