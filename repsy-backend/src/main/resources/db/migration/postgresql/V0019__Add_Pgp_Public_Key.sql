...
CREATE TABLE "public"."pgp_public_key" (
    "id"          uuid         PRIMARY KEY,
...
CREATE UNIQUE INDEX "ux_pgp_public_key__repo_id__fingerprint"
    ON "public"."pgp_public_key" ("repo_id", "fingerprint");
CREATE INDEX "idx_pgp_public_key__repo_id" ON "public"."pgp_public_key" ("repo_id");
