...
CREATE TABLE "public"."maven_version_signature" (
    "id"                  uuid          PRIMARY KEY,
    "artifact_version_id" uuid          NOT NULL,
    "file_name"           varchar(1024) NOT NULL,
    "verified_at"         timestamp     NOT NULL,
    CONSTRAINT "fk_maven_version_signature__artifact_version_id"
        FOREIGN KEY ("artifact_version_id") REFERENCES "public"."maven_artifact_version" ("id") ON DELETE CASCADE,
...
INSERT INTO "public"."maven_version_signature" ("id", "artifact_version_id", "file_name", "verified_at")
SELECT gen_random_uuid(),
       v."id",
       a."artifact_name" || '-' || v."version_name" || '.pom',
       COALESCE(v."last_updated_at", NOW())
FROM "public"."maven_artifact_version" v
         JOIN "public"."maven_artifact" a ON a."id" = v."artifact_id"
WHERE v."signed" = true
