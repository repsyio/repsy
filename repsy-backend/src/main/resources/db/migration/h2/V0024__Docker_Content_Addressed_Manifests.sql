...
--
-- Same statements as the PostgreSQL migration of this version (plain INSERT ... SELECT and correlated
-- subqueries, no UPDATE ... FROM, which H2 lacks); H2 has no partial indexes to worry about here.
