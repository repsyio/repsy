...
// the API port ahead of the SPA, and 'counts' and 'security-summary', the literal segments next to
// {repoName} under /api/repos/) are reserved and cannot be used as a repository name. Keep
