...
export class StatsService {
  ...
  public async getHelmRepoCount(): Promise<number> {
    const url = `${this.apiBaseUrl}/api/repos/HELM/count`;
  ...
  public async fetchHelmRepositoryUsage(repo: string): Promise<RepoUsageInfo> {
    return new Promise<RepoUsageInfo>((resolve, reject) => {
      const url = `${this.apiBaseUrl}/api/repos/${repo}/usage`;
  ...
  public async getHelmRepoInfo(): Promise<RepoListInfo[]> {
