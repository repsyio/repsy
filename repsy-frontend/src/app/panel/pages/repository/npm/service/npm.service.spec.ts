  ...
  describe('with a selected repository', () => {
    ...
    const paged: PagedCase<NpmService>[] = [
      ...
      },
      {
        ...
        notCalled: () => [packageApi.listVersions],
      },
      {
