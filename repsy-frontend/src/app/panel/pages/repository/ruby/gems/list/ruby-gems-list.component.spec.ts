...
describe('RubyGemsListComponent', () => {
  let component: RubyGemsListComponent;
  let service: jasmine.SpyObj<RubyService>;
  ...
  function build(): ListFixture {
    ...
    component = new RubyGemsListComponent(
    ...
    return {
      ...
      fail: () => service.searchGems.and.returnValue(throwError(() => 'boom')),
  ...
  describe('deleteGem', () => {
    describeSimpleDelete(() => ({
      ...
      remove: service.deleteGem,
      invoke: () => component.deleteGem(ITEM_UNDER_TEST),
      title: 'Delete Gem',
