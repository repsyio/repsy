...
/**
 * RPS-1482: a real `python3 -m twine upload` of a package over the upload limit, on a stack started with the limits overlay
...
import { pushPypi } from '../../src/clients/oversize.js';
import { registerSizeLimitSpecs } from '../../src/scenarios/size-limits.js';

registerSizeLimitSpecs({
  protocol: 'pypi',
  client: 'twine upload',
  repoType: RepoType.PYPI,
  adapter: pypiAdapter,
  push: pushPypi,
  clientMessage: /HTTPError: 413 Content Too Large/,
});
