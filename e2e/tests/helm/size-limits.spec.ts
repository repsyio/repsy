...
/**
 * RPS-1482: a real `helm cm-push` (the classic ChartMuseum-protocol upload; the OCI `helm push` sends blobs, which no size variable limits) of a package over the upload limit, on a stack started with the limits overlay
...
import { pushHelm } from '../../src/clients/oversize.js';
...
registerSizeLimitSpecs({
  ...
  adapter: helmClassicAdapter,
  push: pushHelm,
  clientMessage: /Error: 413: .*payloadTooLarge/s,
});
