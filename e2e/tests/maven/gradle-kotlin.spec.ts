...
/**
 * The scenario-driven Gradle suite for the Kotlin DSL (`build.gradle.kts`): the whole shared catalog
...
registerPublishConsumeLoop(gradleAdapter('kotlin'));
registerGradleExtras('kotlin');
