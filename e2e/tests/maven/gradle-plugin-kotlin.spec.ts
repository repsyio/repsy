...
/**
 * The scenario-driven Gradle plugin suite for the Kotlin DSL (`build.gradle.kts`, RPS-133): the shared catalog's
...
registerPublishConsumeLoop(gradlePluginAdapter('kotlin'));
registerGradlePluginExtras('kotlin');
